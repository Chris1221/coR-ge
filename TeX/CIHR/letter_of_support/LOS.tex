...
\fancyhead[L]{ % right
   \includegraphics[height=0.53in]{/Users/Chris/repos/coR-ge/TeX/CIHR/Camh_logo_purple.png}
}
\fancyfoot[L]{}
\fancyfoot[R]{\thepage}
\pagestyle{fancy}
...
\signature{Jo Knight, PhD \\ \small{Associate Professor, Department of Psychiatry, University of Toronto} \\ \small{Collaborative Scientist, Centre for Addiction and Mental Health, Toronto}}
\address{Statistical Genetics Group \\ Centre for Addiction and Mental Health \\ 250 College Street \\ Toronto, Ontario M5T 1R8}
\begin{document}
